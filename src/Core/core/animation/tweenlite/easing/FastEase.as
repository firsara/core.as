 ...
 **/
package core.animation.tweenlite.easing {
	import flash.utils.Dictionary;
	import core.animation.tweenlite.TweenLite;
/**
 ...
 * activate them ONCE in your swf). The following easing equations from the core.animation.tweenlite.easing package are 
 ...
 * 
 * <code>
 * 		import core.animation.tweenlite.easing.*;<br /><br />
 * 		
 ...
 */
	public class FastEase {
		 ...
		 * want to activate an ease that is NOT in the core.animation.tweenlite.easing package (for example 
		 ...
		 * 		import core.animation.tweenlite.easing.FastEase;<br /><br />
		 * 
