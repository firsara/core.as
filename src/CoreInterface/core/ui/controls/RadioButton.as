package core.ui.controls
{
	...
	{
		private const STYLES:Array = ["RadioButton", "RadioButton.off"];
    ...
    public function get active():Boolean { return _active; }
		...
		[Inspectable(name="Label", type=String, defaultValue='RadioButton')]
		public function set value(value:String):void
		{
			_value = String(value);
			if (_value == 'null') _value = 'RadioButton';
      _label.value = value;
			rearrange();
		}
    ...
    override public function draw():void
    {
			...
			_off = Lib.get('ui/radio/radio.off');
			_on = Lib.get('ui/radio/radio.on');
